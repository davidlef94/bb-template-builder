...
const InstantMeta = (props) => {
  ...
  const handleDeleteSuccessMessage = (event) => {
    setDeleteSuccessMessage(event.target.value);
  };
              ...
              <Grid container spacing={4}>
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    onChange={handleDeleteSuccessMessage}
                  />
                </Grid>
                <Grid item xs={12}>
                  <TextField
